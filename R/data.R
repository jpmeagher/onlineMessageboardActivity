...
#' 2019. Consists of 118,253 events within 38,616 converstaions.
#'
#' @format A dataframe with 118,253 observations of 4 variables:
#' \describe{
...
#' initial post. That is, we have a 2017 discussions sampled at random.
#'
#' @format A dataframe with 5891 observations of 4 variables:
#' \describe{
...
#' initial post. That is, we have a 3,862 discussions sampled at random after excluding discussions
#' already included in `train_df`.
#'
#' @format A dataframe with 11,668 observations of 4 variables:
#' \describe{
#'   #'  \item{id}{A unique, positive integer id for each event ordered by
#'  timestamp.}
#'  \item{parent_id}{The id for the parent of each event. Set to 0
