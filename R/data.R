...
#'
#' A data set containing timestamps and branching structure for activity on the
...
#' by posts between April 1 and April 7, 2019 inclusive and observed for 48 hours after the
#' initial post. That is, we have a 704 discussions sampled at random.
#'
#' @format A dataframe with 2,097 observations of 4 variables:
#' \describe{
...
#' seeded  by posts between April 29 and May 10, 2019 inclusive and observed for 48 hours after the
...
#'
#' @format A dataframe with 11,231 observations of 4 variables:
#' \describe{
#'   #'  \item{id}{A unique, positive integer id for each event ordered by
#'  timestamp.}
#'  \item{parent_id}{The id for the parent of each event. Set to 0
