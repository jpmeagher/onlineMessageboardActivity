...
#include "stanExports_branching_point_process.h"

RCPP_MODULE(stan_fit4branching_point_process_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("rstantools_model_branching_point_process")
